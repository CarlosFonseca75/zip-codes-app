...
// Styles.
import styles from "@styles/components/pages/zip-codes/CreateZipCode.module.scss";
...
export default function CreateZipCode({
  ...
  function onCloseModal() {
    try {
      // Close modal.
      setShowModals((flags) => ({ ...flags, createZipCode: false }));
   ...
   * @function
   * @name createZipCode
   * @description Submits the form and creates a new zip code.
   * @param {Event} event - The event object.
   * @returns {void}
   */
  async function createZipCode(event) {
    try {
      ...
      // Show success alert.
      showAlert({ title: "Zip code created", message });
  ...
  return (
    <Modal
      header="Create zip code"
      showModal={showModals.createZipCode}
      setShowModal={onCloseModal}
    >
      <form
        aria-label="Create zip code form"
        className={styles.container}
        onSubmit={createZipCode}
      >
